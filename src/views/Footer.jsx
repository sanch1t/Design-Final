      ...
      <div className="max-w-[1490px] mx-auto px-10 py-[120px]">
        <div className="flex flex-col items-center xl:items-start xl:flex-row xl:justify-between gap-12">
          <div className="w-full xl:w-auto flex flex-col items-center xl:items-start">
            <h2 className="font-mont text-white text-center xl:text-start font-medium text-3xl lg:text-[32px]">
              {newsletter}
            </h2>
            <div className="font-mont relative w-full xs:w-[380px] xl:w-[320px] mt-11">
              <input
                type="text"
                placeholder="Email"
              ...
              <div
                ...
                cursor-pointer text-white font-500"
              >
                Subscribe
              </div>
            </div>
          ...
          <div className="font-mont flex flex-col md:flex-row justify-center items-center md:items-start gap-12 w-full">
        ...
        <h6 className="font-mont text-white text-center text-base lg:text-lg">
          &copy; <span className="text-gradient font-mont font-500">SamStudio</span> - All rights reserved
        </h6>
      </div>
    </div>
  );
