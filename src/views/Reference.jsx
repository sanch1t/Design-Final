  ...
  return (
    <div id="reference" className="mb-[160px] px-10 max-w-[1490px] mx-auto">
      <FadeIn delay={0.25} direction="down">
        <h1 className="text-5xl lg:text-[64px] font-mont font-200 text-fontBlack mb-6 text-center">
          {referenceTitle}
        </h1>
      </FadeIn>
      <FadeIn delay={0.5} direction="down">
        <h5 className="text-[#4F4F4F] font-mont font-400 text-lg xs:text-xl mb-12 text-center">
          {referenceSubtitle}
        </h5>
      </FadeIn>
